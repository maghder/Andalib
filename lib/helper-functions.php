 ...
 * Andalib.
 *
 * This file adds the required helper functions used in the Andalib Theme.
 *
 * @package Andalib
 * @author  AyoubMaghder
 * @license GPL-2.0+
 ...
 */
function andalib_customizer_get_default_link_color() {
 ...
 */
function andalib_customizer_get_default_accent_color() {
 ...
 */
function andalib_color_contrast( $color ) {
 ...
 */
function andalib_color_brightness( $color, $change ) {
